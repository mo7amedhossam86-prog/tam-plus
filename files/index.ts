...
// ده اللي فعلياً بيتصل بخدمة Push بتاعة جوجل/فايرفوكس/أبل عشان يبعت الإشعار
// حتى لو المتصفح والموقع مقفولين تماماً — زي ما بتعمل تطبيقات الموبايل.
...
Deno.serve(async (req) => {
  try {
    ...
    // لو الاشتراك بقى منتهي/غير صالح (410/404) نشيله من الجدول عشان ننضف
